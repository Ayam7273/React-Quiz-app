        ...
        <div className="quiz">
            { !started &&
               <div className="info">
                   <h1>Hello There!</h1>
                   <p>
                       You are about to start a quiz to test your knowledge.
                       This quiz contains { quizData.length } questions.
                       Every question answered correctly will be add 10 points 
                       to your score. If you don't answer correctly, you will get no points.
                       This quiz is also timed, and has average of 20 seconds per questions. 
                       <b>Good Luck {username}!</b>
                   </p>
...

            {
                ...
                <main>
                    ...
                    <footer>
                        ...
                        <button onClick={next} disabled={!questionAnswered} >Next &rarr;</button>
                    </footer>
                </main>
            }
            {
                ...
                <div className="end-of-quiz">
                    <h1>Hooray!!</h1>
                    <p>You have reached the end of this quiz. would you like submit</p>
                    <div className="cta">
